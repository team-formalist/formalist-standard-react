...
var ManyChildForms = function (_React$Component2) {
  ...
  function ManyChildForms() {
    ...
    return _ret = (_temp = (_this2 = _possibleConstructorReturn(this, (_ref = ManyChildForms.__proto__ || Object.getPrototypeOf(ManyChildForms)).call.apply(_ref, [this].concat(args))), _this2), _this2.state = {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "button",
              { className: styles.addButton, onClick: function onClick(e) {
