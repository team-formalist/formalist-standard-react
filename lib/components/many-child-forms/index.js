...
var _jsxFileName = "src/components/many-child-forms/index.js",
    _this = this;
...
var SelectDefault = function SelectDefault(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      option.preview_image_url ? React.createElement("img", { alt: "", style: { maxWidth: "100%" }, src: option.preview_image_url, __source: {
          fileName: _jsxFileName,
          lineNumber: 37
        },
        __self: _this
...
var ManyChildFormsSet = function (_React$Component) {
  _inherits(ManyChildFormsSet, _React$Component);

  function ManyChildFormsSet() {
    _classCallCheck(this, ManyChildFormsSet);

    return _possibleConstructorReturn(this, (ManyChildFormsSet.__proto__ || Object.getPrototypeOf(ManyChildFormsSet)).apply(this, arguments));
  }

  _createClass(ManyChildFormsSet, [{
    key: "render",
  ...
  return ManyChildFormsSet;
}(React.Component);

ManyChildFormsSet.propTypes = {
  children: PropTypes.object
};

var ManyChildForms = function (_React$Component2) {
  _inherits(ManyChildForms, _React$Component2);

  function ManyChildForms() {
    var _ref2;

    var _temp, _this3, _ret;

    _classCallCheck(this, ManyChildForms);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this3 = _possibleConstructorReturn(this, (_ref2 = ManyChildForms.__proto__ || Object.getPrototypeOf(ManyChildForms)).call.apply(_ref2, [this].concat(args))), _this3), _this3.state = {
  ...
  _createClass(ManyChildForms, [{
    ...
    value: function render() {
      ...
      var options = Object.keys(embeddable_forms).map(function (key) {
        return {
          id: key,
...
export var ManyChildFormsFactory = React.createFactory(ManyChildForms);