...
export var remove = /*#__PURE__*/css(colours.primaryColor, ";appearance:none;background-color:transparent;border:none;cursor:pointer;padding:0.17em;padding-left:0.8em;margin-top:-0.3rem;margin-bottom:-0.3rem;transition-property:color;transition-duration:100ms;&:focus,&:hover{colour:", colours.values.error, ";}");
