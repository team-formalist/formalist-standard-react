...
var display = /*#__PURE__*/exports.display = (0, _emotion.css)("composes:", _styles.inputBoxes.inputBox, ";");
...
var selectionItems = /*#__PURE__*/exports.selectionItems = (0, _emotion.css)("composes:", _styles.typography.normal, " ", _styles.typography.sans, ";margin-top:1px;");

var selectionPlaceholder = /*#__PURE__*/exports.selectionPlaceholder = (0, _emotion.css)("composes:", _styles.colours.greyMidColor, " ", _styles.typography.normal, " ", _styles.typography.sans, ";align-items:center;display:flex;flex:1;text-align:left;min-height:2rem;");

var openSelectorButton = /*#__PURE__*/exports.openSelectorButton = (0, _emotion.css)("composes:", _styles.buttons.small, " ", _styles.buttons.buttonHighlight, ";margin-right:-0.3rem;margin-top:-0.2rem;margin-bottom:-0.4rem;");

/* Selection exists */

var remove = /*#__PURE__*/exports.remove = (0, _emotion.css)("composes:", _styles.colours.primaryColor, ";appearance:none;background-color:transparent;border:none;cursor:pointer;padding:0.17em;margin-top:-0.3rem;margin-bottom:-0.3rem;transition-property:color;transition-duration:100ms;&:focus,&:hover{colour:", _styles.colours.values.error, ";}");

var removeText = /*#__PURE__*/exports.removeText = (0, _emotion.css)("display:none;");

var removeX = /*#__PURE__*/exports.removeX = (0, _emotion.css)("composes:", _styles.typography.fallback, " ", _styles.typography.large, ";");
