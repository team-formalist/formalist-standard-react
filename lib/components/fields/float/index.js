 ...
 *
 */
var FloatBase = _react2.default.createClass({
  displayName: 'FloatBase',
  ...
  render: function render() {
    ...
    var Display = (0, _extractDisplayVariant2.default)(displayVariant, Object.assign({}, this.props.displayVariants, displayVariants), 'float');

    return _react2.default.createElement(
      'div',
      { className: _float2.default.base },
      _react2.default.createElement(_header2.default, { id: name, label: label, hint: hint, error: hasErrors }),
      _react2.default.createElement(
        'div',
        { className: _float2.default.display },
        _react2.default.createElement(Display, _extends({
          onChange: this.onChange,
          className: (0, _classnames2.default)((0, _optionClassNames2.default)(_float2.default, config.display_options)),
          error: hasErrors
        }, this.props))
      ),
