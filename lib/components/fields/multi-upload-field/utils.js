...
function filterUniqueObjects(primary, secondary) {
  ...
  primary.forEach(function (primaryObject) {
    secondary.forEach(function (secondaryObject, i) {
...
export { hasImageFormatType, sortArrayByOrder, generateUniqueID, noOp, filterUniqueObjects, sanitiseFileName };