...
var MultiUploadField = _react2.default.createClass({
  ...
  propTypes: {
    ...
    fileTypeMessage: _react2.default.PropTypes.string,
    fileSize: _react2.default.PropTypes.number,
    fileSizeMessage: _react2.default.PropTypes.string
  },
  ...
  onChange: function onChange(files) {
    ...
    var fileTypeMessage = _props.fileTypeMessage;
    var fileSize = _props.fileSize;
    var fileSizeMessage = _props.fileSizeMessage;


    files.map(function (file) {
      status = (0, _validation2.default)(file, fileTypeRegex, fileTypeMessage, fileSize, fileSizeMessage);
      if (!status.success) {
        invalidFiles.push({
          file: file,
          uid: (0, _uid2.default)(10),
   ...
   * @parem {number} index - sourtable item index passed back from Sortable
  ...
  onRemove: function onRemove(index, e) {
    return;
