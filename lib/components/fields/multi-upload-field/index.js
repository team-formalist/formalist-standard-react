...
var MultiUploadField = function (_React$Component2) {
  ...
  function MultiUploadField(props, context) {
    ...
    var files = _this5.initialiseAttributesFromValue(value);
  ...
  _createClass(MultiUploadField, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var files = this.initialiseAttributesFromValue(value).map(function (upload) {
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.initialiseAttributesFromValue = function (value) {
    var files = [];
