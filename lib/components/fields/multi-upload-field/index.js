  ...
  _createClass(MultiUploadField, [{
    ...
    */
    ...
    value: function render() {
      ...
      var fieldClassNames = (0, _classnames2.default)(_styles2.default.base, _defineProperty({}, '' + _styles2.default.baseInline, attributes.inline));
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.renderXHRErrorMessage = function (errorObject, index) {
    ...
    return _react2.default.createElement(
      ...
      {
        key: index,
        className: _styles2.default.validationMessage },
      message,
      _react2.default.createElement(
        'button',
        ...
        _react2.default.createElement(
          'span',
          { className: _styles2.default.removeText },
          'Remove'
        ),
        _react2.default.createElement(
          'div',
          {
            className: _styles2.default.removeX,
  ...
  this.renderXHRErrorMessages = function (XHRErrorMessages) {
    return _react2.default.createElement(
      'div',
      { className: _styles2.default.validationMessages },
  ...
  this.renderPreviewDetails = function (file_name, thumbnailImage) {
    ...
    var titleClassNames = (0, _classnames2.default)((_classNames2 = {}, _defineProperty(_classNames2, '' + _styles2.default.listItem__title, !isProgressTitle), _defineProperty(_classNames2, '' + _styles2.default.progress__title, isProgressTitle), _classNames2));

    var wrapperClassNames = (0, _classnames2.default)(_styles2.default.align_middle, _styles2.default.previewItem__details);
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        { className: _styles2.default.align_middle__content },
        _react2.default.createElement(
          'div',
          { className: _styles2.default.listItem__img },
          thumbnailImage
        )
      ),
      _react2.default.createElement(
  ...
  this.renderPreviewItem = function (fileObject, index) {
    ...
    return _react2.default.createElement(
      'div',
      { className: _styles2.default.previewItem, key: index },
      _react2.default.createElement(
        'span',
        {
          className: _styles2.default.progress__bar,
  ...
  this.renderDefaultTemplate = function (fileObject, index) {
    ...
    return _react2.default.createElement(
      'div',
      { className: _styles2.default.listItem, key: index },
      _react2.default.createElement(
        'div',
        { className: _styles2.default.listItem__body },
        _react2.default.createElement(
          'div',
          { className: _styles2.default.align_middle },
          _react2.default.createElement(
            'div',
            { className: _styles2.default.align_middle__content },
            _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: _styles2.default.listItem__title },
              _react2.default.createElement(
                'a',
