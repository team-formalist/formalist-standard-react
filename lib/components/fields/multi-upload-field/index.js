...
var _initialiseProps = function _initialiseProps() {
  ...
  this.renderPreviewDetails = function (file_name, thumbnailImage) {
    ...
    var titleClassNames = (0, _classnames2.default)((_classNames2 = {}, _defineProperty(_classNames2, '' + styles.listItem__title, !isProgressTitle), _defineProperty(_classNames2, '' + styles.progress__title, isProgressTitle), _classNames2));

    var wrapperClassNames = (0, _classnames2.default)(styles.align_middle, styles.previewItem__details);
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        { className: styles.align_middle__content },
        _react2.default.createElement(
          'div',
  ...
  this.renderPreviewItem = function (fileObject, index) {
    ...
    return _react2.default.createElement(
      'div',
      { className: styles.previewItem, key: index },
      _react2.default.createElement(
        'span',
        {
  ...
  this.renderDefaultTemplate = function (fileObject, index) {
    ...
    return _react2.default.createElement(
      'div',
      { className: styles.listItem, key: index },
      _react2.default.createElement(
        'div',
        { className: styles.listItem__body },
        _react2.default.createElement(
          'div',
          { className: styles.align_middle },
          _react2.default.createElement(
            'div',
            { className: styles.align_middle__content },
            _react2.default.createElement(
