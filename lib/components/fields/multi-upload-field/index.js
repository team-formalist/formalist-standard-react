...
var MultiUploadField = _react2.default.createClass({
  ...
  uploadFile: function uploadFile(fileObject) {
    ...
    (0, _attacheUpload.preSign)(fileObject, presign_url, token).then(function (presignResponse) {
      return (0, _attacheUpload.upload)(presignResponse, fileObject, token, onProgress);
