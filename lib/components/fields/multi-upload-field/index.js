...
var MultiUploadField = _react2.default.createClass({
  ...
  renderThumbnail: function renderThumbnail(url, name, uploadURL, path) {
    return _react2.default.createElement('img', { src: url || this.buildFilePath(uploadURL, path, '50x'), alt: name });
  },
  ...
  renderPreviewItem: function renderPreviewItem(fileObject, i) {
    ...
    var thumbnailImage = hasThumbnail ? this.renderThumbnail(preview, name) : null;
  ...
  renderUploadedFileItem: function renderUploadedFileItem(fileObject, idx) {
    ...
    var thumbnailImage = hasThumbnail ? this.renderThumbnail(thumbnail_url, name, uploadURL, path) : null;

    var pathToOriginal = original_url != null ? original_url : this.buildFilePath(uploadURL, path);
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'a',
                { target: '_blank', href: pathToOriginal },
                name
              )
            )
          )
