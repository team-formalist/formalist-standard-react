...
var MultiUploadField = _react2.default.createClass({
  ...
  }, _defineProperty(_propTypes, 'maxFileSize', _react2.default.PropTypes.number), _defineProperty(_propTypes, 'maxFileSizeMessage', _react2.default.PropTypes.string), _propTypes),
  ...
  renderUploadedFileItem: function renderUploadedFileItem(fileObject, idx) {
    ...
    var thumbnailURL = thumbnail_url ? thumbnail_url : this.buildThumbnailPreview(path);
    return _react2.default.createElement(
      'div',
