...
var MultiUploadField = _react2.default.createClass({
  ...
  onChange: function onChange(files) {
    ...
    var allFiles = multiple ? this.state.files.concat(uploadingFiles) : uploadingFiles;
  ...
  render: function render() {
    ...
    var upload_label = attributes.upload_label;
    var button_label = attributes.button_label;
    var multiple = attributes.multiple;
