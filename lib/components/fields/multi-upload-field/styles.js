...
var listItem = /*#__PURE__*/exports.listItem = (0, _emotion.css)(_styles.colours.greyLightColor, ";", _styles.typography.small, ";", _styles.typography.sans, ";box-sizing:border-box;position:relative;width:100%;");

var previewItem = /*#__PURE__*/exports.previewItem = (0, _emotion.css)(listItem, ";background:greyTint;border-radius:0.25em;overflow:hidden;height:40px;");
...
var listItem__title = /*#__PURE__*/exports.listItem__title = (0, _emotion.css)(_styles.typography.lineHeightNormal, ";overflow:hidden;white-space:nowrap;line-height:40px;a{color:", _styles.colours.values.highlight, ";}");

var progress__title = /*#__PURE__*/exports.progress__title = (0, _emotion.css)(listItem__title, ";color:", _styles.colours.values.white, ";");
...
var validationMessage = /*#__PURE__*/exports.validationMessage = (0, _emotion.css)(_styles.typography.sans, ";", _styles.typography.normal, ";", _styles.colours.errorColor, ";", _styles.colours.errorLightBackground, ";margin-bottom:5px;padding:8px 50px 8px 8px;position:relative;z-index:1;");

var remove = /*#__PURE__*/exports.remove = (0, _emotion.css)(_styles.colours.primaryColor, ";appearance:none;background-color:transparent;border:none;cursor:pointer;padding:1rem;position:absolute;right:10px;top:50%;transform:translateY(-50%);transition-duration:100ms;transition-property:color;z-index:2;&:focus,&:hover{color:", _styles.colours.values.error, ";}");
