...
var IntDisplayDefault = _react2.default.createClass({
  ...
  render: function render() {
    ...
    return _react2.default.createElement(_input2.default, _extends({ className: intFieldClassNames, type: 'number', defaultValue: this.props.value, onChange: this.props.onChange }, numberProps));
  }
});
