...
var _dateTime = require('./date-time.mcss');
...
var DateBase = _react2.default.createClass({
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      'div',
      { className: _dateTime2.default.base },
      _react2.default.createElement(_header2.default, { id: name, label: label, hint: hint, error: hasErrors }),
      _react2.default.createElement(
        'div',
        { className: _dateTime2.default.display },
        _react2.default.createElement(Display, _extends({
          onChange: this.onChange,
          className: (0, _classnames2.default)((0, _optionClassNames2.default)(_dateTime2.default, config.display_options)),
          error: hasErrors
        }, this.props))
      ),
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          _sortable2.default,
          { canRemove: true, onRemove: function onRemove(index) {
              return console.log("removing " + index);
            }, onSort: function onSort(newOrder) {
