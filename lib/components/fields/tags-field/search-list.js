...
var _searchListStyles = require('./search-list-styles');

var styles = _interopRequireWildcard(_searchListStyles);
      ...
      if (hasResults) {
        return _react2.default.createElement(
          ...
          results.map(function (result, i) {
            ...
            var buttonClassNames = (0, _classnames2.default)(styles.optionButton, _defineProperty({}, '' + styles.optionButtonFocus, selected));
...
SearchList.propTypes = {
  ...
  onSearchStart: _propTypes2.default.func,
  onSearchEnd: _propTypes2.default.func,
