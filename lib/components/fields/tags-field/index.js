...
var TagsField = function (_Component) {
  ...
  _createClass(TagsField, [{
    ...
    value: function render() {
      ...
      var popunderContainerClassName = (0, _classnames2.default)('foobar', _defineProperty({}, '' + _tagsField2.default.popunderContainerHidden, tagsLoading));
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            value.map(function (tag, i) {
              ...
              return _react2.default.createElement(
                'span',
                { key: key, className: _tagsField2.default.tag },
                tag,
                _react2.default.createElement(
                  'button',
            ...
            canSearch ? _react2.default.createElement(
              ...
              _react2.default.createElement(_searchList2.default, {
                ...
                onSearchStart: function onSearchStart() {
                  return _this2.setState({ tagsLoading: true });
                },
                onSearchEnd: function onSearchEnd() {
                  return _this2.setState({ tagsLoading: false });
                },
                onSelect: function onSelect(selection) {
                  var added = _this2.addTag(selection.value);
                  if (added) {
                    _this2.clearInput();
                    _this2._input.focus();
                    _this2._popunder.closePopunder();
                  }
                }
              })
            ) : _react2.default.createElement(
