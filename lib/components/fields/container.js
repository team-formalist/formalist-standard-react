  ...
  render: function render() {
    ...
    var fieldActions = {
      ...
      edit: function edit(val) {
        ...
        if (_immutable.List.isList(updatedValue)) {
          updatedValue = updatedValue.toJS();
        }
        return store.batchDispatch([editField(path, val), validateField(path, validate(updatedValue))]);
      }
    };
