...
var label = /*#__PURE__*/exports.label = (0, _emotion.css)([], [], function createEmotionStyledRules() {
  return [{
    "cursor": "pointer",
    "marginRight": "1rem"
  }];
...
var hint = /*#__PURE__*/exports.hint = (0, _emotion.css)([_styles.colours.greyLightColor, _styles.typography.small, _styles.typography.sans], [], function createEmotionStyledRules() {
  return [{}];
});
