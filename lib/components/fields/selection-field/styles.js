...
export var remove = /*#__PURE__*/css(colours.primaryColor, ";appearance:none;background-color:transparent;border:none;cursor:pointer;padding:0.17em;margin-top:-0.3rem;margin-bottom:-0.3rem;transition-property:color;transition-duration:100ms;&:focus,&:hover{colour:", colours.values.error, ";}");

export var removeText = /*#__PURE__*/css("display:none;");

export var removeX = /*#__PURE__*/css(typography.fallback, ";", typography.large, ";");
...
export var selection = /*#__PURE__*/css("strong{font-weight:", typography.fonts.weights.sansBold, ";}italic{font-style:italic;}");