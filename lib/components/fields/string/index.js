...
var StringBase = _react2.default.createClass({
  ...
  render: function render() {
    ...
    var fieldClassNames = (0, _classnames2.default)(_string2.default.base, _defineProperty({}, '' + _string2.default.baseInline, config.inline));
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(Display, _extends({
          ...
          className: (0, _classnames2.default)((0, _optionClassNames2.default)(_string2.default, config.display_options)),
          error: hasErrors
        }, this.props)),
