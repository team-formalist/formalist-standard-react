...
var StringDisplayDefault = _react2.default.createClass({
  ...
  render: function render() {
    ...
    return _react2.default.createElement(_input2.default, { id: name, className: stringFieldClassNames, type: 'text', placeholder: config.placeholder, defaultValue: this.props.value, onChange: this.props.onChange });
  }
});
