...
var _s3UploadField = require('./s3-upload-field');

var _s3UploadField2 = _interopRequireDefault(_s3UploadField);
...
function fields() {
  ...
  return {
    ...
    s3UploadField: wrapField(_s3UploadField2.default, options.s3UploadField)
  };
}
