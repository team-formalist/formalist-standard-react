...
var _DisplayDefault = require('./display-standard');
...
var TextFieldBase = _react2.default.createClass({
  ...
  getInitialState: function getInitialState() {
    var fieldDisplay = this.props.config.display_as ? displayTypes[this.props.config.display_as] : _DisplayDefault2.default;
