...
var SearchMultiSelectionField = function (_Component) {
  ...
  function SearchMultiSelectionField(props) {
    ...
    var selections = attributes.selections;

    // Keep as a property so can always know the "true" set
    // and convert to a list

    _this.cachedSelections = (0, _immutable.List)(selections);
...
SearchMultiSelectionField.propTypes = {
  ...
  attributes: _react2.default.PropTypes.shape((_React$PropTypes$shap = {
    label: _react2.default.PropTypes.string,
  ...
  }, _defineProperty(_React$PropTypes$shap, 'selections', _react2.default.PropTypes.array), _defineProperty(_React$PropTypes$shap, 'render_option_as', _react2.default.PropTypes.string), _defineProperty(_React$PropTypes$shap, 'render_selection_as', _react2.default.PropTypes.string), _React$PropTypes$shap)),
  hint: _react2.default.PropTypes.string,
  label: _react2.default.PropTypes.string,
