...
var TimePicker = _react2.default.createClass({
  ...
  onTimeClick: function onTimeClick(time, e) {
    ...
    this.setState({
      ...
      _this._timeInput.value = _this.state.inputValue;
    });
    this.props.onChange(time.format(dateFormats.time));
  },
  ...
  renderTimeItem: function renderTimeItem(date, items, end, active) {
    ...
    if (end.diff(date) > 0) {
      var _ret = function () {
        ...
        var onClick = _this2.onTimeClick.bind(_this2, date.clone());
        var item = _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            {
              ref: function ref(r) {
                return _this2._buttonActive = isActive ? r : null;
              },
        ...
        return {
          v: _this2.renderTimeItem(date, items, end, active)
        };
      }();
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        _popunder2.default,
        { ref: function ref(r) {
            return _this3._popunder = r;
          }, closeOnEsc: true, closeOnOutsideClick: true, onOpen: this.onPopunderOpen },
        _react2.default.createElement(_input2.default, {
          ref: function ref(r) {
            return _this3._timeInput = r;
          },
