...
var container = /*#__PURE__*/exports.container = (0, _emotion.css)("composes:", _styles.colours.whiteBackground, ";margin-bottom:1.5rem;outline:3px transparent solid;transition-property:outline;transition-duration:100ms;");
...
var header = /*#__PURE__*/exports.header = (0, _emotion.css)("composes:", _styles.colours.greyTintBorder, ";border-bottom-width:1px;border-bottom-style:solid;align-items:center;display:flex;padding:0.5rem 1.5rem;");
var label = /*#__PURE__*/exports.label = (0, _emotion.css)("composes:", _styles.typography.small, " ", _styles.colours.greyMidColor, ";margin-left:0;margin-right:auto;");

var toolbar = /*#__PURE__*/exports.toolbar = (0, _emotion.css)("margin-right:0;margin-left:auto;");

var remove = /*#__PURE__*/exports.remove = (0, _emotion.css)("composes:", _styles.colours.primaryColor, ";appearance:none;background-color:transparent;border:none;cursor:pointer;transition-property:color;transition-duration:100ms;&:focus,&:hover{color:", _styles.colours.values.error, ";}");
