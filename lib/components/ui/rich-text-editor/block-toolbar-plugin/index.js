...
function blockToolbarPlugin() {
  ...
  var blockFormatters = options.blockFormatters || defaults.blockFormatters;
  var blockSet = options.blockSet || defaults.blockSet;
  blockSet.atomic.props = { setReadOnly: options.setReadOnly };
  var blockRenderMap = (0, _immutable.Map)(options.blockRenderMap || defaults.blockRenderMap);
