...
var BlockItems = _react2.default.createClass({
  ...
  renderItemsGroups: function renderItemsGroups(itemsGroups) {
    ...
    var currentBlockType = _props2.currentBlockType;
    ...
    return itemsGroups.map(function (group) {
      ...
      return _react2.default.createElement(
        ...
        displayItem.icon ? _react2.default.createElement('span', { title: displayItem.label, className: iconWrapperClassNames, dangerouslySetInnerHTML: { __html: displayItem.icon } }) : displayItem.label
      );
    });
  },
