  ...
  _createClass(InlineToolbarItems, [{
    ...
    value: function renderFormatters(formatters) {
      ...
      return formatters.map(function (formatter) {
        ...
        var buttonClassNames = (0, _classnames2.default)(styles.button, _defineProperty({}, '' + styles.buttonActive, active));
        var iconWrapperClassNames = (0, _classnames2.default)(styles.iconWrapper, _defineProperty({}, '' + styles.iconWrapperActive, active));
        ...
        return _react2.default.createElement(
          ...
          formatter.icon ? _react2.default.createElement('span', {
    ...
    value: function renderEntities(entities) {
      ...
      return entities.map(function (entity) {
        ...
        return _react2.default.createElement(
          ...
          entity.icon ? _react2.default.createElement('span', {
            title: entity.label,
            className: iconWrapperClassNames,
