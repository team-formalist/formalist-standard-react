...
var defaults = {
  inlineFormatters: ['bold', 'italic', 'code'],
  inlineEntities: ['link']
};
...
function inlineToolbarPlugin() {
  ...
  var inlineFormatters = _options.inlineFormatters;
  var inlineEntities = _options.inlineEntities;

  var inlineItems = inlineFormattersMapping.filter(function (item) {
