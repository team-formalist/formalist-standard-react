var _jsxFileName = "src/components/ui/rich-text-editor/inline-toolbar-plugin/index.js";
...
export default function inlineToolbarPlugin() {
  ...
  var _options = options,
      ...
      additionalFormatters = _options.additionalFormatters,
      additionalEntities = _options.additionalEntities,
      customStyleMap = _options.customStyleMap;
  ...
  return {
    ...
    handleKeyCommand: function handleKeyCommand(command, editorState, _ref) {
      ...
      if (formatter) {
        setEditorState(RichUtils.toggleInlineStyle(editorState, formatter.style));
        return "handled";
      }
      return "not-handled";
    },
