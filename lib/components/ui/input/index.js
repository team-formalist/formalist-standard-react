...
var Input = function (_React$Component) {
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      var inputClassNames = (0, _classnames2.default)(this.props.className, styles.input, (_classNames = {}, _defineProperty(_classNames, '' + styles.error, this.props.error), _defineProperty(_classNames, '' + styles.focus, this.state.focus), _classNames), '' + styles[this.props.size]);
