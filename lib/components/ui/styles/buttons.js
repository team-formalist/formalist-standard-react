...
export var buttonSecondary = /*#__PURE__*/css(button, ";", colours.highlightLightBackground, ";", colours.highlightColor, ";&:hover{background-color:", colours.values.error, ";color:", colours.values.white, ";}");

export var buttonHighlight = /*#__PURE__*/css(button, ";", colours.whiteColor, ";", colours.highlightBackground, ";&:hover{background-color:", colours.values.error, ";}");
