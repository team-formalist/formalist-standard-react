...
export var dropzone = /*#__PURE__*/css(colours.greyLightColor, ";", typography.small, ";", typography.sans, ";min-height:71px;transition:background-color 0.3s;width:100%;z-index:1;&:hover{cursor:pointer;}");
...
export var dropzone__active = /*#__PURE__*/css();
export var dropzone__disable_hover = /*#__PURE__*/css();
