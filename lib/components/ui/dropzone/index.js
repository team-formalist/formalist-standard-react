...
var _class = function (_React$Component) {
  ...
  function _class() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _class.__proto__ || Object.getPrototypeOf(_class)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return _react2.default.createElement(
        'button',
        { onClick: _this.onClick, className: styles.dropzone__button },
        buttonText != null ? buttonText : 'Upload file'
      );
    }, _this.renderLabel = function (label) {
      return _react2.default.createElement(
        'span',
        { className: styles.dropzone__label__wrapper },
        _react2.default.createElement(
          'span',
  ...
  _createClass(_class, [{
    ...
    value: function render() {
      ...
      var dropZoneClassNames = (0, _classnames2.default)(styles.dropzone, (_classNames = {}, _defineProperty(_classNames, '' + styles.dropzone__empty, !children), _defineProperty(_classNames, '' + styles.dropzone__disable_hover, children), _defineProperty(_classNames, '' + styles.dropzone__drag_over, isActive), _classNames));
...
_class.propTypes = {
  ...
  renderPreview: _propTypes2.default.bool,
  multiple: _propTypes2.default.bool,
  children: _propTypes2.default.node,
  disableClick: _propTypes2.default.bool,
  hideDropZoneBtn: _propTypes2.default.bool
};
_class.defaultProps = {
  disableClick: false
};
