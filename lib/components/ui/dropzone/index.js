...
exports.default = _react2.default.createClass({
  ...
  onDragOver: function onDragOver(e) {
    ...
    var highlight = e.dataTransfer.types[0] !== "Files" ? false : true;
  ...
  renderDropzoneLabel: function renderDropzoneLabel(label) {
    return _react2.default.createElement(
      'span',
      { className: _index2.default.dropzone__label },
      label != null ? label : 'Drop image to upload'
    );
  },
  ...
  render: function render() {
    ...
    var dropzoneLabel = _props.dropzoneLabel;
    ...
    var dropZoneClassNames = (0, _classnames2.default)(_index2.default.dropzone, (_classNames = {}, _defineProperty(_classNames, '' + _index2.default.dropzone__disable_hover, children), _defineProperty(_classNames, '' + _index2.default.dropzone__highlight, highlight), _classNames));
