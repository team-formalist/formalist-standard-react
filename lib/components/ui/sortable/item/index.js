...
var Item = function (_React$Component) {
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      ...
      var controlsClasses = (0, _classnames2.default)(styles.controls, _defineProperty({}, '' + styles.controlsVertical, verticalControls));

      return connectDropTarget(connectDragPreview(_react2.default.createElement(
        'div',
        { className: styles.base, style: inline, 'data-name': 'sortable-item' },
        ...
        _react2.default.createElement(
          ...
          canRemove ? _react2.default.createElement(
            'button',
            { className: styles.remove, onClick: this.onRemoveClick },
            _react2.default.createElement(
              'span',
          ...
          canSort ? connectDragSource(_react2.default.createElement(
            'button',
            { className: styles.handle, onClick: this.onHandleClick },
            _react2.default.createElement(
              'span',
              { className: styles.handleText },
              'Drag to reorder'
            ),
            _react2.default.createElement('div', { className: styles.handleLine })
          )) : null
        )
      )));
    }
...
Item.propTypes = {
   ...
   * @type {Number}
   */
  originalIndex: _propTypes2.default.number.isRequired,

  /**
   * Callback: Fires when item is moved
   * @type {Function}
   */
  moveItem: _propTypes2.default.func,
