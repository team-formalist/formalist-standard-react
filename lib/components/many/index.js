...
var Many = function (_React$Component2) {
  ...
  function Many() {
    ...
    return _ret = (_temp = (_this2 = _possibleConstructorReturn(this, (_ref = Many.__proto__ || Object.getPrototypeOf(Many)).call.apply(_ref, [this].concat(args))), _this2), _this2.state = {
      ...
      var attributes = _this2$props2.attributes;
      var store = _this2$props2.store;
      var contentsPath = _this2$props2.contentsPath;
      var path = _this2$props2.path;
      ...
      var attributes = _this2$props3.attributes;
      var store = _this2$props3.store;
      var path = _this2$props3.path;
  ...
  _createClass(Many, [{
    ...
    value: function render() {
      ...
      var labelClassNames = (0, _classnames2.default)(styles.label, _defineProperty({}, '' + styles.labelErrors, hasErrors));
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { className: styles.addButton, onClick: this.addChild },
        ...
        children.count() > 0 ? _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            { className: styles.placeholderButton, onClick: this.addChild },
            'Add the first?'
          )
        ),
