...
function fields(fieldsConfig = {}, globalConfig = {}) {
  ...
  return {
    ...
    dateTimeField: wrapField(
      DateTimeField,
      fieldsConfig.dateTimeField,
      globalConfig
    ),
    hiddenField: wrapField(HiddenField, fieldsConfig.hiddenField, globalConfig),
    multiSelectionField: wrapField(
      MultiSelectionField,
      fieldsConfig.multiSelectionField,
      globalConfig
    ),
    numberField: wrapField(NumberField, fieldsConfig.numberField, globalConfig),
    radioButtons: wrapField(
      RadioButtons,
      fieldsConfig.radioButtons,
      globalConfig
    ),
    ...
    searchSelectionField: wrapField(
      ...
      fieldsConfig.searchSelectionField,
      globalConfig
    ),
    searchMultiSelectionField: wrapField(
      SearchMultiSelectionField,
      fieldsConfig.searchMultiSelectionField,
      globalConfig
    ),
    selectBox: wrapField(SelectBox, fieldsConfig.selectBox, globalConfig),
    selectionField: wrapField(
      SelectionField,
      fieldsConfig.selectionField,
      globalConfig
    ),
    ...
    multiUploadField: wrapField(
      MultiUploadField,
      fieldsConfig.multiUploadField,
      globalConfig
    ),
